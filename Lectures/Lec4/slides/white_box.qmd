...
::: {.columns}
::: {.column width="40%"}
![https://arxiv.org/abs/1702.08608](./figs/paper2.png)
:::
...
## Explainable Boosting Machines
<!-- ![]{./figs/exp2.png} -->
{{< video https://youtu.be/MREiHgHgl0k width=1080 height=420 >}}
<!-- ![](./figs/exp2.png) -->
...
<a href="https://www.microsoft.com/en-us/research/publication/gamut-a-design-probe-to-understand-howdata-scientists-understand-machine-learning-models/"><img src="./figs/paper5.png" alt="HTML tutorial" style="width:100%;height:500px;"></a>
...
<a href="https://arxiv.org/pdf/2112.03245.pdf"><img src="./figs/paper7.png" alt="HTML tutorial" style="width:100%;height:500px;"></a>

Github [here](https://github.com/interpretml/gam-changer).

## Practice 1
Notebook [here](https://colab.research.google.com/drive/1nKE6WIApebHi67yfhH6k5mZN86evLZOM?usp=sharing)

Some other libraries for PDP visualization:
[Scikit-learn](https://scikit-learn.org/stable/modules/partial_dependence.html)
...
![A decision tree of diabetes diagnosis](./figs/paper8.png)
...
::: {.column width="50%"}
![Rule Set: A set of if-then rules.](./figs/paper13.png)
...
![What form does this rule set follow?](./figs/paper14.png)

## Decision Rules: Visual Factors Influence Rule Understanding

::: {.columns}
::: {.column width="65%"}
![Paper: https://arxiv.org/abs/2109.09160](./figs/paper15.png)
...
## Practice 2
Notebook [here](https://colab.research.google.com/drive/12LV2Z_1BbP3efACYp2QxzsPaOrIn8a8l?usp=sharing).
