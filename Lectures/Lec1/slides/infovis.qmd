...
::: {.column width="50%"}
<figure>
    <img src="./figs/cleveland-book-cover.jpg" height="500">
</figure>
:::

::: {.column width="50%"}
<figure>
    <img src="./figs/cleveland-mcgill-paper.jpg" height="500">
</figure>
:::
...
::: {.row height="50%"}
<figure>
    <img src="./figs/cleveland-mcgill-a-vs-b-examples.jpg" width="100%">
</figure>
:::
...
::: {.row height="50%"}
<figure>
    <img src="./figs/cleveland-mcgill-a-vs-b-results.jpg" width="60%">
</figure>
:::
...
* Quantitative data measures numerical differences.. 

* There are two main sub-types:
  - **Interval**: Measures distances (A - B).
  - **Ratio**: Measures proportions or scale factors (A / B).

* Quantitative values can be visualized using position, size, or color, among other channels. A zero baseline is essential for ratio comparisons but optional for interval data.
...
::: {.column width="60%"}
<figure>
    <img src="./figs/barchart.jpg" height="500">
</figure>
:::
:::
...
src="https://www.youtube.com/embed/LmsJJDHfGlI"> 
</iframe>
